...
const ORDER = {
  ...
  lng: 10.7613,
  products: [
    { name: "Casque Audio Pro", quantity: 2, price: "128 TND" },
    { name: "Casque Gaming RGB", quantity: 1, price: "144 TND" },
  ],
};

export function CanceledOrderDetails() {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1 flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-red-500" /> Annulée le{" "}
              {ORDER.date}
            </p>
          </div>
        </div>
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl border border-border/50 bg-gradient-to-br from-card to-card/80 shadow-lg shadow-primary/5 p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-xs text-muted-foreground">Total TTC (prévu)</p>
              <p className="text-2xl font-bold text-foreground">
                {ORDER.total}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl border border-border/50 bg-gradient-to-br from-card to-card/80 shadow-lg shadow-primary/5 p-6">
            <h2 className="text-lg font-semibold text-foreground flex items-center gap-2 mb-4">
              ...
              Livreur (assigné avant annulation)
            </h2>
            {ORDER.deliveryDriver ? (
              ...
              <p className="text-sm text-muted-foreground italic">
                Aucun livreur n'avait été assigné
              </p>
            )}
          </div>
