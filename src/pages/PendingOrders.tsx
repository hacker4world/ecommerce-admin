...
const INITIAL_ORDERS = [
  {
    ...
    totalCost: 297,
    products: ["Casque Audio Pro", "Chargeur sans fil", "Câble USB-C"],
  },
  {
    id: "CMD-102",
    date: "2026-07-07",
    client: "Sarra Mansour",
    productCount: 2,
    status: "in_progress",
    deliveryDriver: "Leila Trabelsi",
    totalCost: 145,
    products: ["Écouteurs Bluetooth", "Câble USB-C"],
  },
  {
    id: "CMD-103",
    date: "2026-07-06",
    ...
    deliveryDriver: null,
    totalCost: 560,
    products: ["Casque Audio Pro", "Casque Gaming RGB", "Enceinte Portable"],
  },
  {
    id: "CMD-104",
    date: "2026-07-05",
  ...
  },
  {
    ...
    deliveryDriver: null,
    totalCost: 210,
    products: ["Chargeur sans fil", "Câble USB-C", "Écouteurs Bluetooth"],
  },
];
...
export function PendingOrders() {
  ...
  // Apply all filters (text search + advanced)
  const filteredOrders = useMemo(() => {
    ...
    if (!isNaN(costTo)) {
      result = result.filter((o) => o.totalCost <= costTo);
    }
    if (filterStatus !== "all") {
      ...
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Gérez les commandes en attente de traitement et de livraison
          </p>
        </div>
      </div>
                ...
                <td className="py-3 px-6 text-right">
                  <div className="flex items-center justify-end gap-1">
                    <Button
                      ...
                      onClick={() => navigate(`/orders/pending/details`)}
                    >
            ...
            <div className="w-full space-y-3 bg-muted/30 rounded-xl p-4 text-sm">
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>Les produits réservés seront remis en stock.</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-5 py-4">
            ...
            <div className="bg-muted/20 rounded-xl p-4 border border-border/50">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm font-medium">Coût total (TND)</span>
              </div>
              <div className="flex items-center gap-2">
                <Input
                  type="number"
