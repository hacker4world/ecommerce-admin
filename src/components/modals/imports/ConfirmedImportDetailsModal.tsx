...
import {
  useConfirmedImportDetails,
  ConfirmedImportDetailsTab,
} from "@/hooks/confirmed-imports/useConfirmedImportDetails";
...
interface ConfirmedImportDetailsModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  importData: ImportResponse;
}

export function ConfirmedImportDetailsModal({
  open,
  onOpenChange,
  importData,
}: ConfirmedImportDetailsModalProps) {
  const { activeTab, setActiveTab, isDeleting, error, handleDelete, reset } =
    useConfirmedImportDetails(importData, () => onOpenChange(false));

  const handleTabChange = (value: string) => {
    setActiveTab(value as ConfirmedImportDetailsTab);
  };
      ...
      <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-xl">
            ...
            Détails de l'entrée confirmée — #{importData.id}
          </DialogTitle>
        </DialogHeader>
