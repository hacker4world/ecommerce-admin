...
import { useFilterPendingImportsModal } from "@/hooks/pending-imports/useFilterPendingImportsModal";
import {
  Building2,
  Factory,
  Filter,
...
interface FilterPendingImportsModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function FilterPendingImportsModal({
  open,
  onOpenChange,
}: FilterPendingImportsModalProps) {
  const {
    supplierInput,
    setSupplierInput,
    manufacturerInput,
    ...
    accountsError,
    handleAccountSearch,
  } = useFilterPendingImportsModal(() => onOpenChange(false));
