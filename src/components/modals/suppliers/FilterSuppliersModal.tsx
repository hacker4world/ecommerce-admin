...
import { useFilterSuppliersModal } from "@/hooks/suppliers/useFilterSuppliersModal";
...
export function FilterSuppliersModal({
  open,
  onOpenChange,
  ...
  const {
    ...
    handleReset,
    clearError,
  } = useFilterSuppliersModal(() => onOpenChange(false));
