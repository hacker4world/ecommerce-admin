// src/components/modals/requests/FilterPendingRequestsModal.tsx
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { useFilterPendingRequestsModal } from "@/hooks/pending-requests/useFilterPendingRequestsModal";
import {
  Filter,
  Calendar,
  Package,
...
interface FilterPendingRequestsModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function FilterPendingRequestsModal({
  open,
  onOpenChange,
}: FilterPendingRequestsModalProps) {
  const {
    ...
    handleReset,
    clearError,
  } = useFilterPendingRequestsModal(() => onOpenChange(false));
