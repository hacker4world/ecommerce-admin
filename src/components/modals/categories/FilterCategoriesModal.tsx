...
import { useFilterCategoriesModal } from "@/hooks/categories/useFilterCategoriesModal";
...
export function FilterCategoriesModal({
  open,
  onOpenChange,
}: FilterCategoriesModalProps) {
  const {
    selectedFamilyId,
    setSelectedFamilyId,
    selectedSubfamilyId,
    ...
    handleReset,
    clearError,
  } = useFilterCategoriesModal(() => onOpenChange(false));
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="subfamily" className="flex items-center gap-2">
            ...
            <CustomSelect
              ...
              onValueChange={(value) => {
                setSelectedSubfamilyId(String(value));
                if (error) clearError();
              }}
              placeholder={
                loadingSubfamilies
