...
import { useFilterPendingExportsModal } from "@/hooks/pending-exports/useFilterPendingExportsModal";
...
interface FilterPendingExportsModalProps {
  open: boolean;
...
export function FilterPendingExportsModal({
  open,
  onOpenChange,
}: FilterPendingExportsModalProps) {
  const {
    exportTypeInput,
    setExportTypeInput,
    warehouseInput,
    ...
    handleReset,
    clearError,
  } = useFilterPendingExportsModal(() => onOpenChange(false));
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Filtrer les sorties en attente
          </DialogTitle>
          <DialogDescription>
