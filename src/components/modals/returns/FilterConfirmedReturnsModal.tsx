...
import { useFilterConfirmedReturnsModal } from "@/hooks/confirmed-returns/useFilterConfirmedReturnsModal";
import {
  Filter,
  Calendar,
  Package,
...
interface FilterConfirmedReturnsModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function FilterConfirmedReturnsModal({
  open,
  onOpenChange,
}: FilterConfirmedReturnsModalProps) {
  const {
    ...
    handleReset,
    clearError,
  } = useFilterConfirmedReturnsModal(() => onOpenChange(false));
